...
- **홀드아웃 재측정 허용** → 확정 필요(사용자 소유, 승인 질문에 포함). 홀드아웃 15건은 LB2 에서
  1회 소진했다. 재측정하면 "봉인 1회" 원칙이 약해지고, 안 하면 과적합 여부를 못 본다.
  기본 제안: **개선이 dev 에서 확인된 경우에만 1회 더** 열고, 그 뒤 이 세트는 은퇴시킨다.
- 그 외 사용자 소유 결정: 없음.
...
- 2026-07-21 plan 작성 (승인 대기) — 리서치 `2026-07-21-lb5-term-linkage-probe.md` 선행
