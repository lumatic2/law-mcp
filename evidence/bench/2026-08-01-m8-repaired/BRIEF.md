...
- **`bench/corpus.json` · `bench/contexts-tf2.json` 과, 이 디렉터리(`evidence/bench/2026-08-01-m8-repaired/`)
...
이 디렉터리(`evidence/bench/2026-08-01-m8-repaired/`)에 자기 번호의 run 파일을 쓴다
