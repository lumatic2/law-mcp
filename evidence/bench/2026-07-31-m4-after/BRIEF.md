# 블라인드 법령 조사 과제 (M4 after 재측정 측정용)
...
- **`bench/corpus.json` · `bench/contexts-tf2.json` 과, 이 디렉터리(`evidence/bench/2026-07-31-m4-after/`)
...
이 디렉터리(`evidence/bench/2026-07-31-m4-after/`)에 자기 번호의 run 파일을 쓴다
